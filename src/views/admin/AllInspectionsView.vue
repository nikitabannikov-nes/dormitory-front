    ...
    <div v-else class="card">
      ...
      <div class="table-wrapper">
        <DataTable :value="filtered" :rows="5" paginator stripedRows>
          ...
          <Column field="inspectorFio" header="Инспектор" sortable style="min-width: 130px">
            <template #body="{ data }">
          ...
          <Column header="Ср." sortable sortField="avgScore" style="min-width: 70px; white-space: nowrap; text-align: center">
            <template #body="{ data }">
